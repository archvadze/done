        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <div id="wallet-status"
                    class="hidden bg-green-100 dark:bg-green-900 border border-green-200 dark:border-green-700 text-green-700 dark:text-green-200 px-4 py-3 rounded-lg mb-4">
                    <div class="flex items-center">
                        <i class="fas fa-wallet mr-2"></i>
                        <span>{{ __('Wallet Connected') }}: <span id="wallet-address"
                                class="font-mono text-sm"></span></span>
                        <button id="disconnect-wallet-btn"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('Total Value') }}
                                    </p>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('Total NFTs') }}
                                    </p>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('Networks') }}
                                    </p>
                                    <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                        {{ $networkCounts->count() }}</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">
                                            {{ __('Most Valuable') }}</p>
                                        <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                            {{ number_format($mostValuable->current_value ?? ($mostValuable->mint_price ?? 0), 2) }}
                                            ETH
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="aspect-square relative">
                                @if ($nft->artwork && $nft->artwork->getThumbnailUrl())
                                    <img src="{{ $nft->artwork->getThumbnailUrl() }}" alt="{{ $nft->name }}"
                                ...
                                <div class="absolute top-2 left-2">
                                    ...
                                    @endphp
                                    <span
                                        class="inline-flex items-center px-2 py-1 rounded text-xs font-medium text-white {{ $networkClass }}">
                                ...
                                @if ($nft->rarity)
                                    <div class="absolute top-2 right-2">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex items-center px-2 py-1 rounded text-xs font-medium text-white {{ $rarityClass }}">
                                            {{ ucfirst($nft->rarity) }}
                                        </span>
                                    </div>
                                @endif
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    @if ($nft->current_value)
                                        <div class="text-right">
                                            <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('Current Value') }}
                                            </p>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (connectBtn) {
                connectBtn.addEventListener('click', function() {
                    ...
                    walletAddress.textContent = mockAddress.substring(0, 6) + '...' + mockAddress.substring(
                        38);
