    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-lg shadow-sm p-8">
                ...
                <form method="POST" action="{{ route('messages.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="message" required rows="6"
                    ...
                    <div class="flex items-center justify-between pt-4">
                        <a href="{{ route('messages.index') }}" class="text-gray-600 hover:text-gray-800 font-medium">
            ...
            <div class="mt-6 bg-blue-50 rounded-lg p-4">
                ...
                <p class="text-blue-700 text-sm mb-3">{{ __('Search for users by name or email to send them a message.') }}
                </p>
                <div class="relative">
