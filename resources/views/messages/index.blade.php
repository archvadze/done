            ...
            <div class="w-1/3 border-r border-gray-200">
                <div class="p-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('messages.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">
                            {{ __('New') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="overflow-y-auto h-full">
                    ...
                    @else
                        <div class="p-8 text-center">
                            ...
                            <a href="{{ route('messages.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-lg shadow-sm p-4">
                ...
                <div class="space-y-2">
                    ...
                    <a href="#" onclick="markAllAsRead()" class="block text-green-600 hover:text-green-800 text-sm">
