            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('support.faq.index') }}"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">FAQ</a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span
                            class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ $category->name }}</span>
                    </div>
                </li>
            </ol>
        </nav>
                ...
                <div class="max-w-md mx-auto">
                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.44-.827-6.072-2.208C7.557 11.169 9.67 10 12 10s4.443 1.169 6.072 2.792zM6.72 6.72L17.28 17.28" />
                    </svg>
                    <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">{{ __('No FAQs Found') }}</h3>
                    <p class="mt-2 text-gray-500 dark:text-gray-400">
                        {{ __('There are no frequently asked questions in this category yet.') }}</p>
                    <div class="mt-6">
                        <a href="{{ route('support.faq.index') }}"
