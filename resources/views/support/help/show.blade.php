            ...
            <article class="lg:col-span-2">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
                    ...
                    <header class="mb-8">
                        ...
                        @if($article->excerpt)
                            <div class="text-lg text-gray-600 dark:text-gray-400 mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                {{ $article->excerpt }}
                            </div>
                        @endif
                    </header>
                    ...
                    <footer class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <span class="text-sm text-gray-600 dark:text-gray-400">{{ __('Was this helpful?') }}</span>
                                <form action="{{ route('support.help.helpful', $article) }}" method="POST" class="inline-block">
                                    @csrf
                                    <button type="submit" class="px-3 py-1 text-sm bg-green-100 text-green-600 hover:bg-green-200 dark:bg-green-900 dark:text-green-400 dark:hover:bg-green-800 rounded-lg transition-colors">
                                        <i class="fas fa-thumbs-up mr-1"></i>{{ __('Yes') }}
                                    </button>
                                </form>
                                <form action="{{ route('support.help.not-helpful', $article) }}" method="POST" class="inline-block">
                                    @csrf
                                    <button type="submit" class="px-3 py-1 text-sm bg-red-100 text-red-600 hover:bg-red-200 dark:bg-red-900 dark:text-red-400 dark:hover:bg-red-800 rounded-lg transition-colors">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            @auth
                                <a href="{{ route('support.tickets.create') }}" class="block w-full text-center px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors text-sm">
