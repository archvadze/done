    ...
    <div class="mb-8">
        ...
        <div class="max-w-md">
            <form action="{{ route('support.help.index') }}" method="GET" class="relative">
                ...
                @if($search)
                    <a href="{{ route('support.help.index') }}" class="absolute right-10 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                                        <a href="{{ route('support.help.show', $article) }}" class="hover:text-blue-600 dark:hover:text-blue-400">
                                            {{ $article->title }}
                                        </a>
                                    </h2>
