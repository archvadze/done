            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">
                        {{ __('Describe your issue in detail and our support team will assist you.') }}</p>
                </div>
                ...
                <form method="POST" action="{{ route('support.tickets.store') }}" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <select name="category" id="category" required
                            ...
                            <option value="community" {{ old('category') === 'community' ? 'selected' : '' }}>
                            ...
                            <option value="bug" {{ old('category') === 'bug' ? 'selected' : '' }}>
                                {{ __('Bug Report') }}</option>
                            <option value="feature" {{ old('category') === 'feature' ? 'selected' : '' }}>
                                {{ __('Feature Request') }}</option>
                            <option value="abuse" {{ old('category') === 'abuse' ? 'selected' : '' }}>
                                {{ __('Report Abuse') }}</option>
                            <option value="other" {{ old('category') === 'other' ? 'selected' : '' }}>{{ __('Other') }}
                            </option>
                        </select>
                        @error('category')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Higher priority tickets receive faster response times.') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('The more details you provide, the better we can help you.') }}</p>
                    </div>
                    ...
                    <div id="behavior-section" class="hidden">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="expected_behavior"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    {{ __('Expected Behavior') }}
                                </label>
                                <textarea name="expected_behavior" id="expected_behavior" rows="3"
                            ...
                            <div>
                                <label for="actual_behavior"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    {{ __('Actual Behavior') }}
                                </label>
                                <textarea name="actual_behavior" id="actual_behavior" rows="3" placeholder="{{ __('What actually happened?') }}"
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
                            {{ __('System information helps us diagnose technical issues faster.') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <br>
                            <span
                                class="text-xs">{{ __('Supported formats: images, PDF, Word documents, text files, log files') }}</span>
                        </p>
                        @error('attachments')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center">
                                <input type="radio" name="contact_preference" value="ticket"
