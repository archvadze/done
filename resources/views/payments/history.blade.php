    ...
    <div class="max-w-6xl mx-auto">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                        ...
                                        @if($payment->fee_amount && $payment->fee_amount > 0)
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                {{ __('Fee') }}: {{ number_format($payment->fee_amount, 2) }} {{ strtoupper($payment->currency) }}
                                            </div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            $statusClass = match($payment->status) {
                                                'completed', 'succeeded' => 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-400',
                                                'pending' => 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-400',
                                                'failed', 'canceled' => 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-400',
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-12 text-center">
                ...
                <a href="{{ route('payments.show') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('Successful Payments') }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900 dark:text-white">
                                @php
                                    $totalSpent = $payments->whereIn('status', ['completed', 'succeeded'])->sum('amount');
