...
@section('description', 'View ' . $user->name . "'s profile, artworks, and achievements on Acumen Craft. " . ($user->bio
    ? Str::limit($user->bio, 120) : 'Discover their creative journey and artistic contributions.'))
                    ...
                    <div class="bg-white p-3 rounded border">
                        ...
                        <div class="mt-2 space-y-1 text-sm">
                            <a href="/users/{{ $user->id }}" class="block text-blue-600 hover:underline">👤
                                Profile</a>
                            <a href="/users/{{ $user->id }}/followers" class="block text-blue-600 hover:underline">👥
                                Followers</a>
                            <a href="/users/{{ $user->id }}/following" class="block text-blue-600 hover:underline">➡️
                                Following</a>
                        </div>
                    </div>
                    <div class="bg-white p-3 rounded border">
