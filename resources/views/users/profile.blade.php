        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="/artworks/create" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Create New</a>
                </div>
                @if($artworksCount > 0)
                            ...
                            <div class="border rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="mt-3 flex space-x-2">
                                        <a href="/artworks/{{ $artwork->id }}" class="text-blue-600 hover:text-blue-800 text-sm">View</a>
                                        <a href="/artworks/{{ $artwork->id }}/edit" class="text-gray-600 hover:text-gray-800 text-sm">Edit</a>
                                        @if($artwork->status === 'draft')
                                            <form method="POST" action="/artworks/{{ $artwork->id }}/publish" class="inline">
                                                @csrf
                    ...
                    @if($artworksCount > 6)
                        <div class="mt-4 text-center">
                            <a href="{{ route('users.artworks', $user) }}" class="text-blue-600 hover:text-blue-800 font-medium">View All Artworks ({{ $artworksCount }})</a>
                        </div>
                    @endif
                @else
                    <div class="text-center py-12 text-gray-500">
                        ...
                        <a href="/artworks/create" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
