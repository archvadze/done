                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        if (currentAvatar.tagName === 'IMG') {
                            ...
                            newImg.className =
                                'h-20 w-20 object-cover rounded-full border-2 border-gray-200';
                ...
                if (hasNewAvatar) {
                    ...
                    if (originalAvatarSrc) {
                        ...
                        defaultDiv.className =
                            'h-20 w-20 rounded-full bg-gray-300 flex items-center justify-center border-2 border-gray-200';
