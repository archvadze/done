...
@section('description', 'Browse the complete artwork collection by ' . $user->name . '. Discover their creative
    portfolio and artistic journey on Acumen Craft.')
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        @if ($user->avatar_url)
                            <img class="h-16 w-16 rounded-full" src="{{ $user->avatar_url }}"
