        ...
        <form method="GET" action="{{ route('admin.artworks') }}"
            ...
            <div>
                ...
                <select id="category" name="category"
                    ...
                    <option value="Digital Art" {{ request('category') === 'Digital Art' ? 'selected' : '' }}>Digital Art
                    </option>
                    <option value="Traditional" {{ request('category') === 'Traditional' ? 'selected' : '' }}>Traditional
                    </option>
                    <option value="Photography" {{ request('category') === 'Photography' ? 'selected' : '' }}>Photography
                    </option>
                    <option value="3D Art" {{ request('category') === '3D Art' ? 'selected' : '' }}>3D Art</option>
                    <option value="Logo Design" {{ request('category') === 'Logo Design' ? 'selected' : '' }}>Logo Design
                    </option>
                </select>
            </div>
            ...
            <div>
                ...
                @if (request()->hasAny(['search', 'category']))
                    <a href="{{ route('admin.artworks') }}" class="ml-2 text-gray-600 hover:text-gray-900 text-sm">
                        Clear
                    </a>
                @endif
            </div>
                                ...
                                <td>
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('artworks.show', $artwork) }}"
                                            class="text-blue-600 hover:text-blue-700 text-sm" target="_blank">
                                            View
                                        </a>
