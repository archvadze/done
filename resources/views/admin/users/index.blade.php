        ...
        <form method="GET" action="{{ route('admin.users') }}"
            ...
            <div>
                ...
                @if (request()->hasAny(['search', 'role', 'status']))
                    <a href="{{ route('admin.users') }}" class="ml-2 text-gray-600 hover:text-gray-900 text-sm">
                        Clear
                    </a>
                @endif
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="admin-badge {{ $user->role === 'admin' ? 'admin-badge-danger' : ($user->role === 'moderator' ? 'admin-badge-warning' : 'admin-badge-info') }}">
