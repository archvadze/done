...
<body class="acumen-bg acumen-text flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 acumen-bg-card shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <h1 class="mb-1 font-medium acumen-text-primary">Let's get started</h1>
                <p class="mb-2 acumen-text-secondary">Laravel has an incredibly rich ecosystem. <br>We suggest starting
                    with the following.</p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        class="flex items-center gap-4 py-2 relative before:border-l before:acumen-border before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                        <span class="relative py-1 acumen-bg-card">
                            <span
                                class="flex items-center justify-center rounded-full acumen-bg-card shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] w-3.5 h-3.5 border acumen-border">
                                <span class="rounded-full acumen-accent w-1.5 h-1.5"></span>
                            </span>
                        </span>
                        <span>
                            Read the
                            <a href="https://laravel.com/docs" target="_blank"
                                class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 acumen-text-accent ml-1">
                    ...
                    <li
                        class="flex items-center gap-4 py-2 relative before:border-l before:acumen-border before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                        <span class="relative py-1 acumen-bg-card">
                            <span
                                class="flex items-center justify-center rounded-full acumen-bg-card shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] w-3.5 h-3.5 border acumen-border">
                                <span class="rounded-full acumen-accent w-1.5 h-1.5"></span>
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="https://cloud.laravel.com" target="_blank"
                            class="acumen-button-primary px-5 py-1.5 text-sm">
                            Deploy now
                        </a>
                    </li>
                </ul>
            ...
            <div
                class="acumen-hero-bg relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                {{-- Laravel Logo --}}
                <svg class="w-full acumen-text-accent transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"
