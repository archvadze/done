...
@section('title', __('Create Community'))

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">{{ __('Create Community') }}</h1>
            ...
            <form method="POST" action="{{ route('communities.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="privacy" 
                        ...
                        <option value="hidden" {{ old('privacy') === 'hidden' ? 'selected' : '' }}>
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a href="{{ route('communities.index') }}" class="flex-1 bg-gray-500 hover:bg-gray-600 text-white py-3 px-6 rounded-lg font-medium text-center transition-colors">
                        {{ __('Cancel') }}
                    </a>
                </div>
            </form>
