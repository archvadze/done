-- Acumen Craft – სრული მონაცემთა მოდელი (SQL)
-- განახლებულია ყველა ძირითადი და დამხმარე მოდულით
...
CREATE TABLE users (
  ...
  provider VARCHAR(32), -- social login
...
-- INDEXES & PERFORMANCE OPTIMIZATION (მაგალითად)
