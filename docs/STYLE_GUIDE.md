...
| მეორადი ღილაკი     | გამჭვირვალე                 | მუქი ოქრო (#f0c75e)   | აქვს ღია ოქროს ფერი ჩარჩო (border)                     |
...
- **მოდალური ფანჯრები:**  
  ფონი: #090909, 1px სისქის მუქი ოქროს ფერი ჩარჩოთი.
...
@font-face {
  ...
  src: url(./docs/bpg_extrasquare_2009.ttf);
}
@font-face {
  font-family: extrasquareCaps;
  src: url(./docs/bpg_extrasquare_mtavruli_2009.ttf);
}
@font-face {
  font-family: NovaSquare;
  src: url(./docs/NovaSquare-Regular.ttf);
}
body {
